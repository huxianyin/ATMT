...
class App extends Component {
  ...
  render() {
    ...
    const TrailAPage = (props) => {
      return (
        <TrailA
          handleNext={this.handleNext.bind(this,"partA")}
          Reset={this.reset}
    ...
    const PartAPage = (props) => {
      return (
        <PartA
          handleNext={this.handleNext.bind(this,"trailB")}
          Reset={this.reset}
          exp_name = {this.state.setting.exp_name}
          num = {this.state.setting.num}
          task_r = {this.state.setting.task_r}
    ...
    const TrailBPage = (props) => {
      return (
        <TrailB
          handleNext={this.handleNext.bind(this,"partB")}
          Reset={this.reset}
          exp_name = {this.state.setting.exp_name}
          task_r = {this.state.setting.task_r}
          onClearHistory={this.handleClearHistory.bind(this)}
    ...
    const PartBPage = (props) => {
      return (
        <PartB
          handleNext={this.handleNext.bind(this,"report")}
          Reset={this.reset}
          exp_name = {this.state.setting.exp_name}
          num = {this.state.setting.num}
          task_r = {this.state.setting.task_r}
    ...
    return (
      <div>
        <Router history={browserHistory}>
              <Route exact path="/" component={MySettingPage}/>
              <Route path='setting' component={MySettingPage} />
              <Route path='trailA' component={TrailAPage} />
              <Route path='partA' component={PartAPage} />
              <Route path='trailB' component={TrailBPage} />
              <Route path='partB' component={PartBPage} />
